...
resource "azurerm_subnet" "snet-p-we-001-aks-pool01" {
...
resource "azurerm_subnet" "snet-p-we-001-aks-svc01" {
...
resource "azurerm_subnet" "snet-p-we-001-aks-fw01" {
...
resource "azurerm_subnet" "snet-p-we-001-aks-waf01" {
